...
namespace CSF.Hosting
{
    ...
    public abstract class HostedCommandResolver<T, TContext> : IHostedCommandResolver
        where T : CommandFramework where TContext : IContext
    {
        ...
        /// <summary>
        ///     Creates a new <see cref="HostedCommandResolver{T, TContext}"/> with provided services.
        /// </summary>
        /// <param name="framework"></param>
        /// <param name="collection"></param>
        /// <param name="logger"></param>
        public HostedCommandResolver(T framework, IServiceProvider collection, ILogger<T> logger)
        {
            Framework = framework;
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _ = ResolveCommandsAsync(cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <summary>
        ///     Builds all modules based on the <see cref="Assembly.GetEntryAssembly()"/> of this application.
        /// </summary>
        /// <param name="cancellationToken">Indicates that the shutdown process should no longer be graceful.</param>
        /// <returns>An asynchronous <see cref="Task"/> with no return type.</returns>
        protected virtual async Task RegisterCommandsAsync(CancellationToken cancellationToken = default)
        {
            await Framework.BuildModulesAsync(Assembly.GetEntryAssembly());
        }
