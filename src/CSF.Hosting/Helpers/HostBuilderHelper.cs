...
namespace CSF.Hosting
{
    ...
    public static class HostBuilderHelper
    {
        ...
        public static IHostBuilder ConfigureCommandManager(this IHostBuilder hostBuilder, Action<HostBuilderContext, BuildConfiguration> action = null)
        {
        ...
        /// <param name="action">Configuration action for the host and manager.</param>
        /// <returns>The same <see cref="IHostBuilder"/> for chaining calls.</returns>
        public static IHostBuilder ConfigureCommandManager<T>(this IHostBuilder hostBuilder, Action<HostBuilderContext, BuildConfiguration> action = null)
            where T : HostedCommandManager
        {
            hostBuilder.ConfigureServices((hostContext, services) =>
            {
                var fxContext = new BuildConfiguration();
